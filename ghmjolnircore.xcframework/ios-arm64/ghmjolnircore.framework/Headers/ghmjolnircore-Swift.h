...
#ifndef GHMJOLNIRCORE_SWIFT_H
#define GHMJOLNIRCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ghmjolnircore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13ghmjolnircore31AlignedCollectionViewFlowLayout")
...
SWIFT_CLASS("_TtC13ghmjolnircore20GHChipViewFlowLayout")
@interface GHChipViewFlowLayout : UICollectionViewFlowLayout
- (NSArray<UICollectionViewLayoutAttributes *> * _Nullable)layoutAttributesForElementsInRect:(CGRect)rect SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13ghmjolnircore34GHStrategyChipCollectionController")
@interface GHStrategyChipCollectionController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13ghmjolnircore30GHStrategyCollectionController")
@interface GHStrategyCollectionController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13ghmjolnircore39GHStrategyNetflixTableSectionController")
@interface GHStrategyNetflixTableSectionController : UITableViewController
...
SWIFT_CLASS("_TtC13ghmjolnircore25GHStrategyTableController")
@interface GHStrategyTableController : UITableViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13ghmjolnircore32GHStrategyTableSectionController")
@interface GHStrategyTableSectionController : UITableViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13ghmjolnircore37GHStrategyTableSectionSwipeController")
@interface GHStrategyTableSectionSwipeController : GHStrategyTableSectionController
...
SWIFT_CLASS("_TtC13ghmjolnircore30GHStrategyTableSwipeController")
@interface GHStrategyTableSwipeController : GHStrategyTableController
- (UISwipeActionsConfiguration * _Nullable)tableView:(UITableView * _Nonnull)tableView trailingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (BOOL)tableView:(UITableView * _Nonnull)tableView canEditRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC13ghmjolnircore20SwiftyStarRatingView")
...
@property (nonatomic, strong) IBInspectable UIImage * _Nullable emptyStarImage;
@property (nonatomic, strong) IBInspectable UIImage * _Nullable halfStarImage;
@property (nonatomic, strong) IBInspectable UIImage * _Nullable filledStarImage;
...
@interface SwiftyStarRatingView (SWIFT_EXTENSION(ghmjolnircore))
